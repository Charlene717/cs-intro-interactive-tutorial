...
(function(){
  ...
  const STR = {
    ...
    rangeAll:        { zh:"全部 16 個章節", en:"All 16 chapters" },
    ...
    quizAllChapters: { zh:"計算機概論 互動考題（全部章節）", en:"Intro to Computer Science Quiz (All Chapters)" },
    quizErrataTitle: { zh:"計算機概論 互動考題", en:"Intro to Computer Science Quiz" },
  ...
  document.addEventListener('DOMContentLoaded', ()=>{
    ...
    if(host && !document.getElementById('langToggle')){
      ...
      btn.style.cssText = 'background:#fff;color:#1d4ed8;border:1px solid rgba(255,255,255,.5);border-radius:999px;padding:5px 14px;font-size:13px;font-weight:700;cursor:pointer;font-family:inherit;white-space:nowrap';
